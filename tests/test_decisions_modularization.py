...
EXPECTED_DECISION_TITLES = {
    ...
    "0041": "v0.4.2 audits Passive Boundary Relevance boundaries",
    "0042": "v0.4.3 aligns contracts and boundary wording",
}
...
def test_decision_numbers_exist_exactly_once_in_modules() -> None:
    ...
    assert headings == [f"{number:04d}" for number in range(1, 43)]
    assert len(headings) == len(set(headings)) == 42
