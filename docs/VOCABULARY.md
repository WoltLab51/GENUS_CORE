...
Kernel planning terms: KernelStateSnapshot, KernelTransitionPreview, KernelConstraintCheckPreview, KernelTraceEntry, KernelReport, and StateInput remain spec-only.
...
docs/vocabulary/boundary_relevance.md - Passive Boundary Relevance vocabulary
docs/vocabulary/kernel.md - Planned GENUS_KERNEL vocabulary
```
