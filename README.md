...
This release defines the planned-not-active output shape for future passive
metrics. It does not implement agents, workers, LLM calls, memory writes,
reactions, decisions, physics metrics, metric functions, cognitive maps,
transition candidates, constraint decisions, runtime cells, organs, or GraphDB
truth.
...
`SCHEMA_VERSION` remains `genus.foundation.v0.0.1`; v0.1.5 is an output-shape
documentation step, not a schema expansion.
